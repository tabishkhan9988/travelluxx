  ...
  return (
    <footer className="bg-slate-950 border-t border-slate-900 pt-16 pb-8 text-slate-300">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="bg-slate-900/60 border border-slate-800/80 rounded-3xl p-6 sm:p-8 mb-12 flex flex-col md:flex-row justify-between items-center gap-6 shadow-xl relative overflow-hidden group">
        ...
        {/* Footnote */}
        <div className="pt-8 border-t border-slate-900 flex justify-center items-center text-xs text-slate-500 font-medium text-center">
          <p>
